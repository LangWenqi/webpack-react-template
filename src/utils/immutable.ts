import { getType, clone } from '@/utils/object';
 ...
 */
interface I_SetOptions {
  assign?: boolean;
  autoCreated?: boolean
}
export const set = (target: any, paths: Array<string | number> | string, value: any, options: I_SetOptions = {}) => {
